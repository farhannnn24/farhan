            ...
            <div class="box">
                ...
                <div class="slide">
                    ...
                    <div class="aksi">
                        ...
                        <a href="#?fotoid=<?=$data['fotoid']?>" class="hapus"><i class="fas fa-trash-alt"></i></a>
                    ...
                    <div class="info">
                        ...
                        <p>Total Komentar: <?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM komentarfoto WHERE fotoid='{$data['fotoid']}'")); ?></p>
                    </div>
                </div>
                <?php 
                            } else {
